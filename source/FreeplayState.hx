...
class FreeplayState extends MusicBeatState
{
	...
	override function create() {
		...
		//songs.push(new TrickyButton(80,360,'menu/freeplay/Helltorture Button','menu/freeplay/Helltorture Confirm',selectSong, 'Helltorture', -30));
		...
		//songFour.spriteOne = new FlxSprite(songFour.trueX + songFour.tweenX, songFour.trueY + songFour.tweenY).loadGraphic(Paths.image('menu/freeplay/Expurgation Button',"torture"), true, 800, 200);
        //songFour.spriteTwo = new FlxSprite(songFour.trueX + songFour.tweenX, songFour.trueY + songFour.tweenY).loadGraphic(Paths.image('menu/freeplay/Expurgation Confirm',"torture"), true, 800, 200);
		...
		add(hedge);
		var shade:FlxSprite = new FlxSprite(-205,-100).loadGraphic(Paths.image('menu/freeplay/Shadescreen','torture'));
		shade.setGraphicSize(Std.int(shade.width * 0.65));
		add(shade);
		var bars:FlxSprite = new FlxSprite(-225,-395).loadGraphic(Paths.image('menu/freeplay/theBox','torture'));
		...
		//else
		//{
			//var locked:FlxSprite = new FlxSprite(songFour.trueX, songFour.trueY).loadGraphic(Paths.image('menu/freeplay/Expurgation Locked','torture'), true, 900, 200);
